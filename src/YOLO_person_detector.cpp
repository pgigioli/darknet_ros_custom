...
char *cfg = "/media/ubuntu/darknet/cfg/yolo-tiny_person.cfg";
char *weights = "/media/ubuntu/darknet/person_face_detector_weights/yolo-tiny_person_30000.weights";
float thresh = 0.3;
int cam_index = 0;
